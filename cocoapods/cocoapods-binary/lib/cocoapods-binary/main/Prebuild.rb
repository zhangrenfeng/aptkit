require_relative './build_framework'
...
module Pod
    class Installer
        ...
        def have_exact_prebuild_cache?
            ...
            existed_framework_names = sandbox.existed_framework_names
            missing = unchanged.select do |pod_name|
                not existed_framework_names.include?(pod_name)
            end
        ...
        def install_when_cache_hit
            # just print log
            self.sandbox.existed_framework_names.each do |name|
                UI.puts "Using #{name}"
            end
        end
        ...
        def prebuild_frameworks!
            ...
            if local_manifest != nil
                ...
                # add the denpendencies
                denpendency_targets = targets.map { |t| t.recursive_dependent_targets }.flatten.uniq || []
                targets = (targets + denpendency_targets).uniq
            else
            ...
            # Remove useless files and pods
            all_needed_names = self.pod_targets.map(&:name).uniq
            useless_names = sandbox.existed_framework_names.reject do |name|
