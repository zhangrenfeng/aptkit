...
module Pod
    class Prebuild
        ...
        #
        class Passer
            # indicate the add/remove/update of prebuilt pods
            # @return [Analyzer::SpecsState]
            class_attr_accessor :prebuild_pods_changes

            # represent the path of resources to copy
            class ResourcePath
                attr_accessor :real_file_path
                attr_accessor :target_file_path
            end

            # Save the resources for static framework, and used when installing the prebuild framework
            # static framework needs copy the resources mannully
            #
